...
const apiKey = "K3hEUxGIUNs0Jus6QTHQcYCH5kQpCbxnnQMwSgmEIJj242FPZnj3f2p9";
const perPage = 15;
let currentPage = 1;
let searchTerm = null;
...
$(document).ready(function () {
    $('#menu').click(function () {
        $('#navi').toggleClass('nav-toggle'); // Updated to match the ID 'navi' from your HTML
    });

    $(window).on('scroll load', function () {
        $('#navi').removeClass('nav-toggle');
